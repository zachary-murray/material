/**
 * @license AngularJS v1.3.19-local+sha.f98e038
...
function minErr(module, ErrorConstructor) {
  ...
  return function() {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.19-local+sha.f98e038/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.19-local+sha.f98e038',    // all of these placeholder strings will be replaced by grunt's
