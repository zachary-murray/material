angular
    ...
    .controller('MdChipsController', MdChipsController);
 ...
 *
 * @param this.$scope
 * @param this.$mdConstant
 * @param this.$log
 * @param this.$element
 * @constructor
 */
function MdChipsController ($scope, $mdConstant, $log, $element, $timeout, $mdAria) {
...
MdChipsController.prototype = {
   ...
   * @param index
   */
  removeAndSelectAdjacentChip : function(index) {
   ...
   */
  getAdjacentChipIndex : function(index) {
   ...
   * actually provided.
   */
  useMdOnAppendExpression : function() {
  ...
  removeChipAndFocusInput : function (index) {
    this.removeChip(index);
    this.onFocus();
  },
  /**
   ...
   * @param index
   */
  selectAndFocusChipSafe : function(index) {
   ...
   * @param index
   */
  selectAndFocusChip : function(index) {
    this.selectChip(index);
    if (index != -1) {
      this.focusChip(index);
    }
   ...
   * @param ngModelCtrl
   */
  configureNgModel : function(ngModelCtrl) {
   ...
   * @param inputElement
   */
  configureUserInput : function(inputElement) {
    ...
    var scope = this.$scope, ctrl = this;
    inputElement
        .attr({ tabindex: 0 })
  ...
  /**
   * Validate input for required aria-label
   */
  validateAccessibility : function(inputElement) {
    inputElement = inputElement || this.$element.find('input');
    this.$mdAria.validateAriaLabel(inputElement, this.$element);
  },


  configureAutocomplete : function(ctrl) {
